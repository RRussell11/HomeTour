...
public  static String[] collectInput() {
	...
	public static void printRoom(Player player) {
		...
		try (Scanner in = new Scanner(System.in)) {
			while(true) {
				System.out.println("Enter: go North/South/East/West' to move or 'Exit', direction0 "+ " or Continue entering options:");
			...
			System.out.println("mini_ Home Theather,  mini-home theather room is locate East direction3.This is the entertaiment room,"
   ...
   // }while(true) {
			...
			//System.out.print("Do you like to visit the library, Y/N : ");
			//String library = in.next();

  
			//System.out.print("Would you like to visit the miniTheater, Y/N : ");

			//String miniTheather = in.next();*/
   // boolean end = false;
			//while(! end){
			System.out.print
			("I do hope you  enjoyed the experience to learn about the Modern Home-Dream edition.(Please,enter 'go + direction' to get back to the menu)");
