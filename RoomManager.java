...
//public Object startingRoom;
	...
	public void init() {
	       ...
	       Room dining = new Room("The Dining", "dining room",
	               "The dining for entertaining people , with tables and chairs . Crossing the open hall, is the dining room which "
		...
		List<String> directions1 = dining.getDirections();
	       ...
	       rooms = new Room[directions.size()]; 
	       Room mini_Theater = new Room("mini_ Home Theather", "mini_Theater ", "This is the entertaiment room,"
	       		+ "You're invite to watch movies" );
	       List<String> directions3 = Hall.getDirections();
	       rooms = new Room[directions.size()];
	       Room masterBedroom = new Room("masterBedroom", "bedroom","This masterBedroom locate north-west"+ "the vanish edition has access "
